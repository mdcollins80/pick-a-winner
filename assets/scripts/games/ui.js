...
const onGetGamesSuccess = function (data) {
  ...
  // COMMENTED OUT THE HANDLEBARS CODE:
  ...
  sorted.forEach(function (game) {
    const element = $('<li data-id="' + game.id + '"class="game-list-item">Week: ' + game.week_num + '  |  Kickoff: ' + game.time + '  |  Away ID: ' + game.away_team_id + '  |  Home ID: ' + game.home_team_id + '<button type="submit" data-id="' + game.away_team_id + '" class="away-button">Away</button>  <button type="submit" data-id="' + game.home_team_id + '" class="home-button">Home</button></li>')
