...
var getPicks = function getPicks() {
  return $.ajax({
...
var getPick = function getPick(data) {
  return $.ajax({
...
var createPick = function createPick(data) {
  return $.ajax({
    url: config.apiOrigin + '/picks',
    method: 'POST',
    headers: {
...
var updatePick = function updatePick(data) {
  return $.ajax({
...
var deletePick = function deletePick(data) {
  return $.ajax({
    url: config.apiOrigin + '/picks/' + data.pick.id,
    method: 'DELETE',
    headers: {
...
var pickEvents = __webpack_require__(38);
...
var gameApi = __webpack_require__(19);
var gameUi = __webpack_require__(20);
...
var showGamesTemplate = __webpack_require__(21);
...
var onGetGamesSuccess = function onGetGamesSuccess(data) {
  ...
  };var showGamesHtml = showGamesTemplate(sorted);
  $('.games-table').remove();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td>"
    ...
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.week_num : stack1), depth0))
    + "</td>\n      <!--<button data-id={game.away_team} class=\"btn btn-default away-team\">{game.away_team}</button> used to go in the next td.  Use for next version in place of input and create button. -->\n      <td>"
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.home_team : stack1), depth0))
    + "\" name=\"pick[winning_team]\">\n          <input type=\"hidden\" class=\"hidden-game-id\" name=\"pick[game_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          <button type=\"submit\" class=\"btn btn-success create-pick-btn\">Create Pick</button>\n        </form>\n      </td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<tbody class=\"games-table\">\n  <tr>\n    <th>GameID</th>\n    <th>Week</th>\n    <th>Away Team</th>\n    <th>Home Team</th>\n    <th>Predicted Winner</th>\n  </tr>\n"
...
var getFormFields = __webpack_require__(6);
var store = __webpack_require__(4);
var pickApi = __webpack_require__(9);
var pickUi = __webpack_require__(39);

var onCreatePick = function onCreatePick(event) {
  event.preventDefault();
  if (event.target && event.target.matches('form.pick')) {
    ...
    if (data.pick.winning_team.length > 0) {
      ...
      pickApi.createPick(data).then(pickUi.onCreatePickSuccess).catch(pickUi.onCreatePickFailure);
    } else {
...
var onGetPicks = function onGetPicks(event) {
  event.preventDefault();
  pickApi.getPicks().then(pickUi.onGetPicksSuccess).catch(pickUi.onGetPicksFailure);
};

var onUpdateOrDeletePick = function onUpdateOrDeletePick(event) {
  event.preventDefault();
...
var onUpdatePick = function onUpdatePick(event) {
  ...
  pickApi.updatePick(data).then(pickUi.onUpdatePickSuccess).catch(pickUi.onUpdatePickFailure);
};

var onDeletePick = function onDeletePick(event) {
  event.preventDefault();
  var data = getFormFields(event.target);

  pickApi.deletePick(data).then(pickUi.onDeletePickSuccess).catch(pickUi.onDeletePickFailure);
};

module.exports = {
  onCreatePick: onCreatePick,
  onGetPicks: onGetPicks,
  onUpdateOrDeletePick: onUpdateOrDeletePick,
...
var showPicksTemplate = __webpack_require__(40);
var pickApi = __webpack_require__(9);

var onGetPicksSuccess = function onGetPicksSuccess(data) {
  var sorted = {
    picks: data.picks.sort(function (a, b) {
      return a.game.id - b.game.id;
    })
    // HANDLEBARS for dynamically loading the Picks
  };var showPicksHtml = showPicksTemplate(sorted);
  $('.picks-table').remove();
  $('.user-picks-card').append(showPicksHtml);
  $('#message').show().text('Successfully retrieved your picks!'); // .fadeOut(5000)
};

var onGetPicksFailure = function onGetPicksFailure() {
  $('#message').show().text('Problem loading picks.'); // .fadeOut(5000)
};

var onCreatePickSuccess = function onCreatePickSuccess() {
  $('#message').show().text('Pick submitted.'); // .fadeOut(5000)
  pickApi.getPicks().then(onGetPicksSuccess).catch(onGetPicksFailure);
};

var onCreatePickFailure = function onCreatePickFailure() {
  $('#message').show().text('Problem with pick submission.'); // .fadeOut(5000)
};

var onUpdatePickSuccess = function onUpdatePickSuccess(data) {
  $('#message').show().text('Successfully updated pick.'); // .fadeOut(5000)
  pickApi.getPicks().then(onGetPicksSuccess).catch(onGetPicksFailure);
};

var onUpdatePickFailure = function onUpdatePickFailure() {
  $('#message').show().text('Update didn\'t to through!'); // .fadeOut(5000)
};

var onDeletePickSuccess = function onDeletePickSuccess() {
  $('#message').show().text('Delete success!'); // .fadeOut(5000)
  pickApi.getPicks().then(onGetPicksSuccess).catch(onGetPicksFailure);
};

var onDeletePickFailure = function onDeletePickFailure() {
  $('#message').show().text('Delete failed!'); // .fadeOut(5000)
};

module.exports = {
  onGetPicksSuccess: onGetPicksSuccess,
  onGetPicksFailure: onGetPicksFailure,
  onCreatePickSuccess: onCreatePickSuccess,
  onCreatePickFailure: onCreatePickFailure,
  onUpdatePickSuccess: onUpdatePickSuccess,
  onUpdatePickFailure: onUpdatePickFailure,
  onDeletePickSuccess: onDeletePickSuccess,
  onDeletePickFailure: onDeletePickFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.game : stack1)) != null ? stack1.id : stack1), depth0))
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.game : stack1)) != null ? stack1.away_team : stack1), depth0))
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.game : stack1)) != null ? stack1.home_team : stack1), depth0))
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.game : stack1)) != null ? stack1.winning_team : stack1), depth0))
    + "</td>\n      <td>\n        <form class=\"user-update-pick\">\n          <input type=\"text\" name=\"pick[winning_team]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.winning_team : stack1), depth0))
    + "\">\n          <input type=\"hidden\" class=\"hidden-pick-id\" name=\"pick[id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          <button type=\"submit\" class=\"btn btn-warning\">Update</button>\n        </form>\n      </td>\n      <td>\n        <form class=\"user-delete-pick\">\n          <button type=\"submit\" class=\"btn btn-danger\" name=\"pick[id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n        </form>\n      </td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<tbody class=\"picks-table\">\n  <tr>\n    <th>Game</th>\n    <th>Away Team</th>\n    <th>Home Team</th>\n    <th>Actual Winner</th>\n    <th>Predicted Winner</th>\n    <th></th>\n  </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.picks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</tbody>\n";
},"useData":true,"useBlockParams":true});
